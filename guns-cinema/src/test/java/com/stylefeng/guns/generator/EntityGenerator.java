...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("F:\\maoyanMovie\\guns-cinema\\src\\main\\java");//这里写你自己的java目录
        ...
        //strategy.setInclude(new String[]{"mooc_banner","mooc_actor","mooc_category_dict","mooc_source_dict","mooc_year_dict","mooc_film","mooc_film_info"});
        strategy.setInclude(new String[]{"area","field","hall","brand","cinema","hall_film_info"});
